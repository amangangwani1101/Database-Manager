...
public:
   ...
   {
   	system("CLS");
       cout << "This program considered as simple database of students in college , you can make it ordered by name or by ID , there are some functions help you to create a database : \n"
            << "Crate Function : \n"
...
system("CLS");
                ...
                cout<<"Student Name -> ";
                    getline(cin ,name);
                    long long int name_ptr=0;
                    bool ok = true;
                    for(;name_ptr<name.size();name_ptr++){
                        if(name[name_ptr]<65 or name[name_ptr]>122){
                            Sleep(2000);
                            cout << " Wrong input !\n";
                            system("cls");
                            ok = false;
